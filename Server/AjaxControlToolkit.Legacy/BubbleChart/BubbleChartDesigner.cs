...
{
    /// <summary>
    /// Control Designer for the BubbleChart
    /// </summary>
    ...
    public class BubbleChartDesigner : System.Web.UI.Design.ControlDesigner
    {
        /// <summary>
        /// Gets reference of BubbleChart component
        /// </summary>
        ...
        private AjaxControlToolkit.BubbleChart BubbleChart
        {
            get
            {
                return (AjaxControlToolkit.BubbleChart)Component;
            }
        }
