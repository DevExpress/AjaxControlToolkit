...
To learn more, read the <a href="http://www.asp.net/learn/Ajax-Control-Toolkit/tutorial-47-cs.aspx">Getting Started Tutorial</a>, or the other walkthroughs, tutorials and videos shown on the left.
    ...
    <br />
        <p>
        <strong><u>Note:</u></strong> This April 2010 release: <strong>Toolkit version 4.1.0</strong> is <em>only</em>
        for users who are building on top of <strong>.NET Framework 3.5</strong> or <strong>4.0</strong> using <strong>Visual Studio 2008</strong> or <strong>2010</strong>.
    <br />
      If you are using <strong>.NET Framework 2.0</strong> and <strong>Visual Studio 2005</strong> then you should use the 
            earlier Toolkit version <a href="http://ajaxcontroltoolkit.codeplex.com/Release/ProjectReleases.aspx?ReleaseId=11121">1.0.20229</a>.</p>
</asp:Content>
