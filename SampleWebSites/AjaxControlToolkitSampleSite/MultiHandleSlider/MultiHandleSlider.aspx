<%@ Page
    ...
    Inherits="MultiHandleSlider_MultiHandleSlider"
    Title="MultiHandleSlider Sample"
...
<asp:Content ID="Content" ContentPlaceHolderID="SampleContent" runat="Server">
    <ajaxToolkit:ToolkitScriptManager
        ...
        <div class="demoarea">
        <div class="demoheading">MultiHandleSlider Demonstration</div>
        <table style="margin:auto">
            ...
            <tr>
                <td style="width:250px;float:left;">
                    <h3>One Handle</h3>
                    <br />
                    A single-handled slider is still fully supported. This example borrows from the
                    original
                        <asp:HyperLink
                            ID="lnkSlider"
                            runat="server"
                            NavigateUrl="~/Slider/Slider.aspx"
                            Text="Slider" />
            ...
            <tr style="height:180px;" valign="middle">
                <td colspan="2">
                    <br /><h3>Two Handles - Custom</h3><br />
    ...
    <asp:Panel id="Description_ContentPanel" runat="server" style="overflow:hidden;">
        <p>
            ...
            <br /><br />
            Much of the MultiHandleSlider's design is based on the original <asp:HyperLink
                                                                    ID="HyperLink1"
                                                                    runat="server"
                                                                    NavigateUrl="~/Slider/Slider.aspx"
                                                                    Text="Slider" />, so you may want to review
