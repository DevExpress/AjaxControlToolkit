...
Sys.Extended.UI.SliderBehavior.prototype = {
    ...
    _initializeLayout : function() {
        ...
        var defaultHandleImageUrl = (this._isHorizontal) ? '<%= WebResource("Sys.Extended.UI.Slider.Images.slider_h_handle.gif") %>'
            : '<%= WebResource("Sys.Extended.UI.Slider.Images.slider_v_handle.gif") %>';
