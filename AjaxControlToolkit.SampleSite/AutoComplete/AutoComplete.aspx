...
public string[] GetCompletionList(
    string prefixText, int count, string contextKey) { ... }</pre>
                ...
                <li><strong>Animations</strong> - Generic animations for the AutoComplete extender. See the <a href="https://github.com/DevExpress/AjaxControlToolkit/wiki/Animation">Animation Reference</a> for more details.
                <ul>
