...
&lt;ajaxToolkit:DropDownExtender runat="server" ID="DDE"
    ...
    <em>DropDownControlID</em>="DropPanel" /&gt;
            ...
            <ul>
                ...
                <li><strong>Animations</strong> - Generic animations for the DropDown extender.  See the <a href="https://github.com/DevExpress/AjaxControlToolkit/wiki/Animation">Animation Reference</a> for more details.
                <ul>
