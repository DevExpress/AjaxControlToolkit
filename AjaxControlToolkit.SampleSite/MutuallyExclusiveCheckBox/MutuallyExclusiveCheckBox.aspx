...
<asp:Content ContentPlaceHolderID="InfoContent" runat="Server">
    <samples:InfoBlock runat="server" Collapsed="false">
        ...
        <Content>
            <div runat="server" ControlType="MutuallyExclusiveCheckBoxExtender" ContentType="description" />
        </Content>
    </samples:InfoBlock>
    ...
    <samples:InfoBlock runat="server">
        ...
        <Content>
            <div runat="server" ControlType="MutuallyExclusiveCheckBoxExtender" ContentType="members" />
        </Content>
    </samples:InfoBlock>
</asp:Content>
