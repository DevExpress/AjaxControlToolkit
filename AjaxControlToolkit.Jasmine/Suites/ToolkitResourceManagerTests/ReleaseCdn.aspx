<%@ Page Title="" Language="C#" MasterPageFile="~/Suites/Suite.Master" AutoEventWireup="true" CodeBehind="ReleaseCdn.aspx.cs" Inherits="AjaxControlToolkit.Jasmine.Suites.ToolkitResourceManagerTests.ReleaseCdn" %>
    ...
    <script>
        describe("ToolkitResourceManager", function() {
            ...
            describe("CDN", function() {
                ...
                it("loads cdn release script", function() {
