# AJAX Control Toolkit (maintained by [DevExpress](https://go.devexpress.com/AjaxControlToolkit_CodePlex_DevExpressHome.aspx))
...
**v16.1 is now available**! [Get the new installer from DevExpress.com](https://go.devexpress.com/AjaxControlToolkit_CodePlex_DevExpressPage.aspx).

![logo](http://download-codeplex.sec.s-msft.com/Download?ProjectName=ajaxcontroltoolkit&DownloadId=1437723)
...
[Download](https://go.devexpress.com/AjaxControlToolkit_CodePlex_DevExpressPage.aspx) the DevExpress Edition of the AJAX Control Toolkit today, evaluate it in your project and let us know what you think.

Watch the **Getting Started** video (click the image):

[![video](http://img.youtube.com/vi/24hIhS2itUU/hqdefault.jpg)](https://youtu.be/24hIhS2itUU)
