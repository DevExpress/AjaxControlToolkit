<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnimateModalpopup.aspx.cs"
    Inherits="AjaxControlToolkit.Tests.Bugs.ModalPopup._6944.AnimateModalpopup" %>
...
<body>
    ...
    <div>
                ...
                <table style="height: 100%; width: 100%">
                    <tr>
                        <td style="text-align: left; vertical-align: top" valign="top">
                            ...
                            <br />
                            You can animate the closing of the popup also. Click the Close to see this.
                        </td>
                    </tr>
                    <tr>
                ...
                <Animations>
                    ...
                    <OnHiding>
                        <Sequence>                            
                            ...
                            <Parallel>
                                <FadeOut />
                                <Scale ScaleFactor="0.2" Center="True" />
                            </Parallel>
                        </Sequence>
                    </OnHiding>            
                </Animations>
        ...
        <asp:Panel ID="Description_HeaderPanel" runat="server" Style="cursor: pointer;">
            <div class="heading">
                <asp:ImageButton ID="Description_ToggleImage" runat="server" ImageUrl="collapse.jpg"
        ...
        <asp:Panel ID="Description_ContentPanel" runat="server" Style="overflow: hidden;">
            <p>
                ...
                then it is centered vertically or horizontally. The four animation events may be
                used to add visual effects and animations to the popup or any other control on the
                page before/after the popup is made visible/hidden.
            </p>
        </asp:Panel>
        <asp:Panel ID="Properties_HeaderPanel" runat="server" Style="cursor: pointer;">
            <div class="heading">
                <asp:ImageButton ID="Properties_ToggleImage" runat="server" ImageUrl="expand.jpg"
    ...
    <em>PopupDragHandleControlID</em>="Panel3"&gt;
        <em>&lt;Animations&gt; &lt;OnShowing&gt; ... &lt;/OnShowing&gt; &lt;OnShown&gt; ...
            &lt;/OnShown&gt; &lt;OnHiding&gt; ... &lt;/OnHiding&gt; &lt;OnHidden&gt; ... &lt;/OnHidden&gt;
            &lt;/Animations&gt;</em>
    &lt;/ajaxToolkit:ModalPopupExtender&gt;
    </pre>
            <ul>
                ...
                <li><strong>OnShowing</strong> - Generic animation played just before the the popup
                    is shown.</li>
                <li><strong>OnShown</strong> - Generic animation played right after the the popup is
                    shown.</li>
                <li><strong>OnHiding</strong> - Generic animation played just before the the popup is
                    hidden.</li>
                <li><strong>OnHidden</strong> - Generic animation played right after the popup is hidden.</li>
            </ul>
        </asp:Panel>
        <script type="text/javascript">
