<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="AjaxControlToolkit.Tests.Bugs.Tabs._13037.WebForm1" %>
...
<body>
    ...
    <div>
        ...
        <act:TabContainer ID="TabContainer1" runat="server">
            ...
            <act:TabPanel ID="second" HeaderText="second" Enabled="false" runat="server">
                <ContentTemplate>
                    <br />
