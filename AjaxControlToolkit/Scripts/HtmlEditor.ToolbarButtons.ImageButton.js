...
Sys.Extended.UI.HtmlEditor.ToolbarButtons.ImageButton.prototype = {
    ...
    _onmouseover: function(e) {
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.ImageButton.callBaseMethod(this, "_onmouseover")) return false;
    ...
    _onmouseout: function(e) {
        ...
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.ImageButton.callBaseMethod(this, "_onmouseout")) return false;
        if(this._hoverSrc.length > 0) {
    ...
    _onmousedown: function(e) {
        if(Sys.Extended.UI.HtmlEditor.ToolbarButtons.ImageButton.callBaseMethod(this, "_onmousedown") === null) return null;
    ...
    _onmouseup: function(e) {
        var node = this.get_element();
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.ImageButton.callBaseMethod(this, "_onmouseup")) return false;
        if(this._downSrc.length > 0) {
