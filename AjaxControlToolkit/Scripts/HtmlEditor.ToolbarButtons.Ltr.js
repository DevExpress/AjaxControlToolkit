...
Sys.Extended.UI.HtmlEditor.ToolbarButtons.Ltr.prototype = {
    callMethod: function() {
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.Ltr.callBaseMethod(this, "callMethod")) return false;
    ...
    checkState: function() {
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.Ltr.callBaseMethod(this, "checkState")) return false;
