...
Sys.Extended.UI.HtmlEditor.ToolbarButtons.Rtl.prototype = {
    callMethod: function() {
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.Rtl.callBaseMethod(this, "callMethod")) return false;
    ...
    checkState: function() {
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.Rtl.callBaseMethod(this, "checkState")) return false;
