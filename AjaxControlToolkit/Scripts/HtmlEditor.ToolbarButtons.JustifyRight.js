...
Sys.Extended.UI.HtmlEditor.ToolbarButtons.JustifyRight.prototype = {
    checkState: function() {
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.JustifyRight.callBaseMethod(this, "checkState")) return false;
        return this._designPanel._textAlignState("right");
    },

    callMethod: function() {
        if(!Sys.Extended.UI.HtmlEditor.ToolbarButtons.JustifyRight.callBaseMethod(this, "callMethod")) return false;
