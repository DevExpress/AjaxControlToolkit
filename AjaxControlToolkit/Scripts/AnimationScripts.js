...
$AA.registerAnimation = function(name, type) {
    ...
    // framework.
    // param "name" is the name of the animation that will be used as the XML tag name in the XML animation description.  It
...
$AA.createAnimation = function(obj, defaultTarget) {
    // <summary>
    // The createAnimation function builds a new
    ...
    // </param>
    // <param name="defaultTarget" type="Sys.UI.DomElement" mayBeNull="true" domElement="true">
    // The function also takes a defaultTarget parameter that is used as the
...
$AA.Animation.prototype = {
    ...
    setValue: function(value) {
        ...
        // </summary>
        // <param name="value" type="Object">Current state of the animation (as retreived from getAnimatedValue)</param>
        // <returns />
        throw Error.notImplemented();
    },
...
$AA.SequenceAnimation = function(target, duration, fps, animations, iterations) {
    ...
    // SequenceAnimation cannot be a child of a <see cref="Sys.Extended.UI.Animation.ParallelAnimation" />
...
$AA.ConditionAnimation = function(target, duration, fps, animations, conditionScript) {
    ...
    // JavaScript that should evaluate to true or false to determine which child
    // animation to play.
    // </param>
...
$AA.FadeAnimation = function(target, duration, fps, effect, minimumOpacity, maximumOpacity, forceLayoutInIE) {
    ...
    // Determine whether to fade the element in or fade the element out.  The possible values are FadeIn
...
$AA.FadeAnimation.prototype = {
    ...
    setValue : function(value) {
        ...
        // Current opacity (as retreived from getAnimatedValue)
        // </param>
        // <remarks>
...
$AA.InterpolatedAnimation = function(target, duration, fps, property, propertyKey, startValue, endValue) {
    ...
    // </param>
    // <param name="property" type="String" mayBeNull="true" optional="true">
    // Property of the target element to set when animating.  The default value is 'style'.
    // </param>
    // <param name="propertyKey" type="String" mayBeNull="true" optional="true">
    // Optional key of the property to be set (which indicates the value property[propertyKey], like style['backgroundColor']). Note that for the style property, the key must be in a JavaScript friendly format (i.e. backgroundColor instead of background-color).
    // </param>
...
$AA.ColorAnimation.prototype = {
    ...
    getAnimatedValue : function(percentage) {
        ...
        // </param>
        // <returns type="String">
        // Current color formatted as a 7-character hex string (like #246ACF).
        // </returns>
...
$AA.ColorAnimation.getRGB = function(color) {
    ...
    // Color formatted as a 7-character hex string (like #246ACF)
    // </param>
    // <returns type="Object">
    // Object representing the color with Red, Green, and Blue properties.
    // </returns>
...
$AA.ColorAnimation.toColor = function(red, green, blue) {
    ...
    // </param>
    // <returns type="String">
    // Color as a 7-character hex string (like #246ACF)
    // </returns>
