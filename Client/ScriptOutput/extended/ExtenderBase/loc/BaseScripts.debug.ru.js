...
"TextCount_DefaultAlertFormat": "Максимальная длина {2}",
"TextCount_DefaultDisplayFormat": "Кол-во: {0} Осталось букв: {1} Максимальная длина: {2}",
"TextCount_DefaultInsertText": "Вставить",
"TextCount_DefaultKeyboardModeFormat": "Режим клавиатуры: {3}",
"TextCount_DefaultOverwriteText": "Презаписать"
};
