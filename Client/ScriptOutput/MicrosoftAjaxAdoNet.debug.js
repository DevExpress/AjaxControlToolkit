...
$type = Sys.Data.AdoNetQueryBuilder = function Data$AdoNetQueryBuilder(uri) {
    /// <summary locid="M:J#Sys.Data.AdoNetQueryBuilder.#ctor">Allows construction of ADO.NET Data Service queries.</summary>
...
$type.prototype = {
    ...
    _uri: null,
    get_skip: function AdoNetQueryBuilder$get_skip() {
        /// <value type="Number" integer="true" mayBeNull="true" locid="P:J#Sys.Data.AdoNetQueryBuilder.skip">The number of elements to skip when returning results, or null if no skip value is specified.</value>
        return this._getIntParam("$skip");
    },
    set_skip: function AdoNetQueryBuilder$set_skip(value) {
        this._setParam("$skip", value);
    },
    get_top: function AdoNetQueryBuilder$get_top() {
        /// <value type="Number" integer="true" mayBeNull="true" locid="P:J#Sys.Data.AdoNetQueryBuilder.top">The maximum number of elements to return, or null if no maximum is specified.</value>
        return this._getIntParam("$top");
    },
    set_top: function AdoNetQueryBuilder$set_top(value) {
        this._setParam("$top", value);
    },
    get_orderby: function AdoNetQueryBuilder$get_orderby() {
        /// <value type="String" mayBeNull="true" locid="P:J#Sys.Data.AdoNetQueryBuilder.orderby">The ordering applied to the result set, or null if no ordering is specified.</value>
        return this._getStringParam("$orderby");
    },
    set_orderby: function AdoNetQueryBuilder$set_orderby(value) {
        this._setParam("$orderby", value);
    },
    get_filter: function AdoNetQueryBuilder$get_filter() {
        /// <value type="String" mayBeNull="true" locid="P:J#Sys.Data.AdoNetQueryBuilder.filter">The filter applied to the result set, or null if no filter is specified.</value>
        return this._getStringParam("$filter");
    },
    set_filter: function AdoNetQueryBuilder$set_filter(value) {
        this._setParam("$filter", value);
    },
    get_expand: function AdoNetQueryBuilder$get_expand() {
        /// <value type="String" mayBeNull="true" locid="P:J#Sys.Data.AdoNetQueryBuilder.expand">The property expansion applied to the result set, or null if no property expansion is specified.</value>
        return this._getStringParam("$expand");
    },
    set_expand: function AdoNetQueryBuilder$set_expand(value) {
        this._setParam("$expand", value);
    },
    get_resourcePath: function AdoNetQueryBuilder$get_resourcePath() {
        /// <value type="string" locid="P:J#Sys.Data.AdoNetQueryBuilder.resourcePath">The resource path of this QueryBuilder object.</value>
        return this._uri;
    },
    ...
    get_queryParameters: function AdoNetQueryBuilder$get_queryParameters() {
        /// <value type="Object" locid="P:J#Sys.Data.AdoNetQueryBuilder.queryParameters">A dictionary of query parameters. This object will be non-null but may contain no fields if no query parameters have been set.</value>
        return this._queryParameters;
    },
    set_queryParameters: function AdoNetQueryBuilder$set_queryParameters(value) {
        this._queryParameters = value;
    },
    toString: function AdoNetQueryBuilder$toString() {
        /// <summary locid="M:J#Sys.Data.AdoNetQueryBuilder.toString">Generates a complete query string based on this object's resource path and parameter dictionary.</summary>
    ...
    _getIntParam: function AdoNetQueryBuilder$_getIntParam(name) {
        var value = parseInt(this._queryParameters[name]);
        return (isNaN(value)) ? null : value;
    },
    _getStringParam: function AdoNetQueryBuilder$_getStringParam(name) {
        var value = this._queryParameters[name];
        return value || null;
    },
    _setParam: function AdoNetQueryBuilder$_setParam(name, value) {
...
$type.registerClass("Sys.Data.AdoNetQueryBuilder");
$type = Sys.Data._AdoNetUtil = function Data$_AdoNetUtil() {
    throw Error.invalidOperation();
}

$type.concatUris = function _AdoNetUtil$concatUris(serviceUri, resourceUri) {
...
$type.extractETag = function _AdoNetUtil$extractETag(item) {
    return (item.__metadata) ? (item.__metadata.etag || null) : null;
}

$type.extractUri = function _AdoNetUtil$extractUri(item) {
    return (item.__metadata) ? (item.__metadata.uri || null) : null;
}

$type.registerClass("Sys.Data._AdoNetUtil");    
$type = Sys.Data.AdoNetActionResult = function Data$AdoNetActionResult(result, httpHeaders, actionContext, operation) {
    /// <summary locid="M:J#Sys.Data.AdoNetActionResult.#ctor"></summary>
...
$type.prototype = {
    ...
    _result: null,
    _headers: null,
    get_httpHeaders: function AdoNetActionResult$get_httpHeaders() {
        /// <value type="Object" locid="P:J#Sys.Data.AdoNetActionResult.httpHeaders">A dictionary of HTTP headers associated with the entry for this action in a batch response.</value>
        return this._headers;
    },
    get_actionContext: function AdoNetActionResult$get_actionContext() {
        /// <value mayBeNull="true" locid="P:J#Sys.Data.AdoNetActionResult.actionContext">A context associated with this operation.</value>
        return this._actionContext;
    },
    get_operation: function AdoNetActionResult$get_operation() {
        /// <value type="String" locid="P:J#Sys.Data.AdoNetActionResult.operation">The operation that was performed.</value>
        return this._operation;
    },
    get_result: function AdoNetActionResult$get_result() {
        /// <value type="Object" mayBeNull="true" locid="P:J#Sys.Data.AdoNetActionResult.result">The result of the operation, or null if there was no result.</value>
        return this._result;
    }
}
$type.registerClass("Sys.Data.AdoNetActionResult");
$type = Sys.Data.AdoNetActionSequence = function Data$AdoNetActionSequence(dataService) {
    /// <summary locid="M:J#Sys.Data.AdoNetActionSequence.#ctor">Exposes methods for performing batch operations against a web-based data service.</summary>
    /// <param name="dataService" type="Sys.Data.AdoNetServiceProxy">The AdoNetServiceProxy object against which to perform operations.</param>
    this._actionQueue = [];
    this._dataService = dataService;
}
$type.prototype = {
    get_serviceProxy: function AdoNetActionSequence$get_serviceProxy() {
        /// <value type="Sys.Data.AdoNetServiceProxy" locid="P:J#Sys.Data.AdoNetActionSequence.serviceProxy">The DataService.</value>
        return this._dataService;
    },
    addInsertAction: function AdoNetActionSequence$addInsertAction(item, resourceSetUri, actionContext) {
        /// <summary locid="M:J#Sys.Data.AdoNetActionSequence.addInsertAction">Adds an insertion to the execution queue.</summary>
    ...
    addUpdateAction: function AdoNetActionSequence$addUpdateAction(item, updateItemUri, actionContext) {
        /// <summary locid="M:J#Sys.Data.AdoNetActionSequence.addUpdateAction">Adds an update to the execution queue.</summary>
    ...
    addRemoveAction: function AdoNetActionSequence$addRemoveAction(item, actionContext) {
        /// <summary locid="M:J#Sys.Data.AdoNetActionSequence.addRemoveAction">Adds a removal to the execution queue.</summary>
        /// <param name="item" type="Object" mayBeNull="true">Item to remove.</param>
        /// <param name="actionContext" mayBeNull="true" optional="true">A context object associated with this operation.</param>
        this._actionQueue.push([2, null, item, actionContext]);
    },
    clearActions: function AdoNetActionSequence$clearActions() {
        /// <summary locid="M:J#Sys.Data.AdoNetActionSequence.clearActions">Clears the action queue.</summary>
        this._actionQueue = [];
    },
    execute: function AdoNetActionSequence$execute(succeededCallback, failedCallback, userContext) {
        /// <summary locid="M:J#Sys.Data.AdoNetActionSequence.execute">Executes operations in the action queue.</summary>
    ...
    _batchCompleted: function AdoNetActionSequence$_batchCompleted(executor) {
...
$type.registerClass("Sys.Data.AdoNetActionSequence");
$type._getError = function AdoNetActionSequence$_getError(timedOut, statusCode, message, errorObject, operation) {
...
$type = Sys.Data.AdoNetInvokeParametersBuilder = function Data$AdoNetInvokeParametersBuilder() {
    /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.#ctor">Creates an empty AdoNetInvokeParametersBuilder object.</summary>
...
$type.prototype = {
    ...
    get_parameters: function AdoNetInvokeParametersBuilder$get_parameters() {
        /// <value locid="P:J#Sys.Data.AdoNetInvokeParametersBuilder.parameters">A dictionary of parameters. This object will be non-null but may contain no fields if no parameters have been set.</value>
    ...
    addBoolean: function AdoNetInvokeParametersBuilder$addBoolean(name, value) {
        /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.addBoolean">Adds a Boolean parameter to the builder.</summary>
    ...
    addDate: function AdoNetInvokeParametersBuilder$addDate(name, value, includeTimeZone) {
        /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.addDate">Adds a Date parameter to the builder.</summary>
        /// <param name="name" type="String">The name of the parameter to be added.</param>
    ...
    addDecimal: function AdoNetInvokeParametersBuilder$addDecimal(name, value) {
        /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.addDecimal">Adds a Decimal parameter to the builder.</summary>
        /// <param name="name" type="String">The name of the parameter to be added.</param>
    ...
    addDouble: function AdoNetInvokeParametersBuilder$addDouble(name, value) {
        /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.addDouble">Adds a floating point parameter to the builder.</summary>
        /// <param name="name" type="String">The name of the parameter to be added.</param>
        /// <param name="value" type="Number">The value of the parameter to be added.</param>
    ...
    addGuid: function AdoNetInvokeParametersBuilder$addGuid(name, value) {
        /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.addGuid">Adds a GUID parameter to the builder.</summary>
        /// <param name="name" type="String">The name of the parameter to be added.</param>
    ...
    addInteger: function AdoNetInvokeParametersBuilder$addInteger(name, value) {
        /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.addInteger">Adds an integer parameter to the builder.</summary>
        /// <param name="name" type="String">The name of the parameter to be added.</param>
    ...
    addString: function AdoNetInvokeParametersBuilder$addString(name, value) {
        /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.addString">Adds a string parameter to the builder.</summary>
        /// <param name="name" type="String">The name of the parameter to be added.</param>
    ...
    toString: function AdoNetInvokeParametersBuilder$toString() {
        /// <summary locid="M:J#Sys.Data.AdoNetInvokeParametersBuilder.toString">Generates a complete query string based on this object's parameter dictionary.</summary>
        /// <returns type="String">The complete query string.</returns>
...
$type.registerClass("Sys.Data.AdoNetInvokeParametersBuilder");
$type = Sys.Data.AdoNetServiceProxy = function Data$AdoNetServiceProxy(serviceUri) {
    /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.#ctor"></summary>
    /// <param name="serviceUri" type="String">Path to the ADO.NET Data Service.</param>
...
$type.prototype = {
    ...
    get_path: function AdoNetServiceProxy$get_path() {
        /// <value type="String" mayBeNull="false" locid="P:J#Sys.Data.AdoNetServiceProxy.path">The path to the ADO.NET Data Service.</value>
        return this.get_serviceUri();
    },
    set_path: function AdoNetServiceProxy$set_path(value) {
        throw Error.notImplemented(Sys.Data.AdoNetRes.cannotChangePath);
    },
    get_replaceOnUpdate: function AdoNetServiceProxy$get_replaceOnUpdate() {
        /// <value type="Boolean" mayBeNull="false" locid="P:J#Sys.Data.AdoNetServiceProxy.replaceOnUpdate">True if the update() method should replace a server item entirely; false if the method should merge new values into the old item.</value>
        return this._replaceOnUpdate;
    },
    set_replaceOnUpdate: function AdoNetServiceProxy$set_replaceOnUpdate(value) {
        this._replaceOnUpdate = value;
    },
    get_serviceUri: function AdoNetServiceProxy$get_serviceUri() {
        /// <value type="String" mayBeNull="false" locid="P:J#Sys.Data.AdoNetServiceProxy.serviceUri">The path to the ADO.NET Data Service.</value>
        return this._serviceUri;
    },
    createActionSequence: function AdoNetServiceProxy$createActionSequence() {
        /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.createActionSequence">Creates a new action sequence for execution against this data service.</summary>
        /// <returns type="Sys.Data.AdoNetActionSequence">An action sequence object.</returns>
        return new Sys.Data.AdoNetActionSequence(this);
    },
    insert: function AdoNetServiceProxy$insert(item, resourceSetUri, succeededCallback, failedCallback, userContext, webRequest) {
        /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.insert">Performs an insertion against the data service.</summary>
        /// <param name="item" type="Object">Item to insert.</param>
    ...
    invoke: function AdoNetServiceProxy$invoke(operationUri, httpVerb, parameters, succeededCallback, failedCallback, userContext, webRequest) {
        /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.invoke">Invokes a method exposed by the data service.</summary>
    ...
    fetchData: function AdoNetServiceProxy$fetchData(operation, parameters, mergeOption, httpVerb, succeededCallback, failedCallback, timeout, userContext) {
        /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.fetchData">Fetches data from the provided service URI.</summary>
        /// <param name="operation">The operation to fetch data with.</param>
        /// <param name="parameters" type="Object" mayBeNull="true" optional="true"></param>
    ...
    fetchDeferredProperty: function AdoNetServiceProxy$fetchDeferredProperty(item, property, succeededCallback, failedCallback, userContext, webRequest) {
        /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.fetchDeferredProperty">Fetches the property of a given item.</summary>
    ...
    query: function AdoNetServiceProxy$query(query, succeededCallback, failedCallback, userContext, webRequest) {
        /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.query">Performs a query (read) against the data service.</summary>
    ...
    update: function AdoNetServiceProxy$update(item, succeededCallback, failedCallback, userContext, webRequest) {
        /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.update">Performs an update against the data service.</summary>
    ...
    remove: function AdoNetServiceProxy$remove(item, succeededCallback, failedCallback, userContext, webRequest) {
        /// <summary locid="M:J#Sys.Data.AdoNetServiceProxy.remove">Performs a removal against the data service.</summary>
    ...
    _checkForError: function AdoNetServiceProxy$_checkForError(executor, operation, checkVersion) {
    ...
    _onResponseComplete: function AdoNetServiceProxy$_onResponseComplete(executor, onSuccess, onFailure, userContext, operation) {
    ...
    _prepareWebRequest: function AdoNetServiceProxy$_prepareWebRequest(item, relativeUri, verb, onSuccess, onFailure, context, operation, webRequest) {
...
$type._createFailedError = function AdoNetServiceProxy$_createFailedError(operation, errorMessage) {
...
$type.registerClass("Sys.Data.AdoNetServiceProxy", Sys.Net.WebServiceProxy, Sys.Data.IDataProvider);
Sys.registerComponent($type);
$type = Sys.Data._AdoNetBatchReader = function Data$_AdoNetBatchReader(responseBody, boundary) {
...
$type.prototype = {
    get_responses: function _AdoNetBatchReader$get_responses() {
        return this._responses;
    },
    _parseParts: function _AdoNetBatchReader$_parseParts(responses) {
    ...
    _parseHttpResponse: function _AdoNetBatchReader$_parseHttpResponse() {
    ...
    _parseHeaders: function _AdoNetBatchReader$_parseHeaders(target) {
        for (var line = this._readLine(); line; line = this._readLine()) {
            var h = this._parseHeader(line);
            target[h.name] = h.value;
        }
    },
    _parseHeader: function _AdoNetBatchReader$_parseHeader(s) {
        if (s === null) return null;
        var index = s.indexOf(":");
        return (index === -1) ? null :
            { name: s.substring(0, index).trim(), value: s.substring(index + 1).trim() };
    },
    _parseStatus: function _AdoNetBatchReader$_parseStatus(s) {
        var match = Sys.Data._AdoNetBatchReader._statusRegExp.exec(s);
        return match ? ({ code: match[1], text: match[2] }) : null;
    },
    _currentBoundary: function _AdoNetBatchReader$_currentBoundary() {
        return this._boundary[this._boundary.length - 1];
    },
    _eof: function _AdoNetBatchReader$_eof() {
        return this._position === -1;
    },
    _readLine: function _AdoNetBatchReader$_readLine() {
        return this._readToMark("\r\n", false);
    },
    _readToMark: function _AdoNetBatchReader$_readToMark(mark, nullIfMissing) {
    ...
    _peek: function _AdoNetBatchReader$_peek(len) {
        if (this._eof()) return "";
        return this._responseBody.substring(this._position, this._position + len);
    }
}
$type._boundaryFromTypeHeader = function _AdoNetBatchReader$_boundaryFromTypeHeader(header) {
    var re = /;\s*boundary=(.*)$/i,
        match = re.exec(header);
    return match ? match[1] : null;
};
$type._parseResponse = function _AdoNetBatchReader$_parseResponse(executor) {
...
$type.registerClass("Sys.Data._AdoNetBatchReader");
$type = Sys.Data._AdoNetBatchWriter = function Data$_AdoNetBatchWriter(host) {
    this._host = host;
    this._content = "";
    this._boundary = null;
...
$type.prototype = {
    get_contentType: function _AdoNetBatchWriter$get_contentType() {
        return this._contentType;
    },
    set_contentType: function _AdoNetBatchWriter$set_contentType(type) {
        this._contentType = type;
    },
    get_requestBody: function _AdoNetBatchWriter$get_requestBody() {
        return this._content + "--" + this.get_topBoundary() + "--";
    },
    get_topBoundary: function _AdoNetBatchWriter$get_topBoundary() {
        if (!this._boundary) {
            this._boundary = "batch_" + this._createBoundary();
        }
        return this._boundary;
    },
    addChange: function _AdoNetBatchWriter$addChange(targetUri, eTag, method, body, contentId) {
        this._changesetEntries.push({ uri: targetUri, eTag: eTag, method: method, body: body, contentId: contentId });
    },
    addQuery: function _AdoNetBatchWriter$addQuery(queryUri) {
        this._content += this._startPart(this.get_topBoundary(), "GET", queryUri, null) + "\r\n";
    },
    endChangeSet: function _AdoNetBatchWriter$endChangeSet() {
        var changeset = "";
    ...
    startChangeSet: function _AdoNetBatchWriter$startChangeSet() {
        this._changesetBoundary = "changeset_" + this._createBoundary();
        this._changesetEntries = [];
    },
    _createBoundary: function _AdoNetBatchWriter$_createBoundary() {
        function hex16() {
            return Math.floor((1 + Math.random()) * 0x10000).toString(16).substr(1);
        }
        return hex16() + "-" + hex16() + "-" + hex16();
    },
    _startPart: function _AdoNetBatchWriter$_startPart(boundary, method, uri, eTag, contentId) {
...
$type.registerClass("Sys.Data._AdoNetBatchWriter");
}
